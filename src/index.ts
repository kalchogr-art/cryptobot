    ...
    const VERSION = "V1.9.18 MECHANICAL VS RAW OBSERVER";
      ...
      async fetch(request: Request, env: Env): Promise<Response> {
        ...
        if (url.pathname === "/mechanical-vs-raw") {
          ...
          try {
            ...
            const rawCorrect = rawResolved.filter(
            ...
            return json({
              ...
              worker: "cryptobot",
              version: VERSION,
              module: "MECHANICAL_VS_RAW_OBSERVER",
              ...
              summary: {
                ...
                raw_accuracy_pct:
                  rawResolved.length > 0
                    ? round((rawCorrect / rawResolved.length) * 100, 2)
                    : null,
              },
              signals: rows,
            });
